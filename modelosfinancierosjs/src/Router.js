        ...
        <div className="contenedor">
          ...
          <Switch>
            ...
            <Route
              exact
              path="/desarrollo"
              render={() => <Desarrollo conceptos={this.state.conceptos} />}
            />
            ...
            <Route
              exact
              path="/desarrollo/:desarrolloId"
              render={(props) => {
                let idDesarrollo = props.location.pathname.replace(
                  "/desarrollo/",
                  ""
                );
                return (
            ...
            <Modelo datosModelo={this.datosModelo} />
